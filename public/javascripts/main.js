...
$.ajax({
    ...
    const cluster1={
        content : `<div class="cluster1">
         </div>`
    };

    const cluster2={
        content: `<div class="cluster2">
        </div>`
    };
    const cluster3={
        content: `<div class="cluster3">
        </div>`
    };
...
const tooltip = $(
    `<div style="position:absolute;z-index:10000;padding:5px 10px;background:white;border:1px solid black;font-size:14px;display:none;pointer-events:none;">
    </div>`
);
